...
interface Props {
    ...
    classErrorInput?: string
    classErrorMessage?: string
    classNameEye?: string
    classDistance?: string
    classDistanceError?: string
...
export default function Input({
    ...
    classErrorMessage = 'mt-1 text-red-500 min-h-[1.25rem] text-sm',
    classNameInput = 'p-3 w-full outline-none border border-gray-300 focus:border-gray-500 rounded-sm focus:shadow-sm',
    classErrorInput = 'p-3 w-full outline-none border border-red-300 focus:border-red-600 rounded-sm focus:shadow-sm text-red-500',
    ...rest
}: Props) {
    ...
    return (
        <div className={`relative ${errorMessage ? classDistanceError : classDistance}`}>
            <input
                {...rest}
                autoComplete='on'
                type={handleType()}
